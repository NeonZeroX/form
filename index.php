...
<head>
  ...
  <title>Form data-63118343</title>
...
<body>
        ...
        <div class="form-row">
          ...
          <div class="form-row">
            ...
            <select class="form-control" id="religion">
              ...
              <option value="islam">พราหมณ์-ฮินดู</option>
            </select>
          </div>
          <br>
          ...
          <div class="d-grid gap-2">
            <button id="btnsand" class="btn btn-primary" type="button"
              style="margin-top: 20px; margin-bottom: 20px; background-color: #000000; "button"
  ...
  <footer class="w3-container w3-padding-64 w3-light-grey w3-center w3-large"> 
    ...
    <h1>63118343 Jirawat Chatree</h1>
  </footer>   
